...
public class EscribirArchivo {
    ...
    public EscribirArchivo(String nombreAlg, int tam, double rmin, double rmax, long semilla,
        ...
        this.solActual = new Vector<Double>(tam);
        escribir();
    }
    ...
    public void escribir() throws Exception {
        ...
        switch (op) {
            case 1:
                ...
                aux = BLocal.Blocal3(tam, evaluaciones, solActual, rmin, rmax, nAlg, iteraciones);
            ...
            case 2:
                ...
                aux = BLocal.BlocalK(tam, evaluaciones, solActual, rmin, rmax, nAlg, iteraciones);
